...
public class Menu {
    ...
    public static String introMenu()
    {
        ...
        print("3- Cerca un parametro nei libri");
        print("4- Visualizza i libri disponibili");
        print("5- Esci");
        String choiche = scanner.nextLine();
        return choiche;
    }
    ...
    public static String loggedUserMenu()
    {
        ...
        print("4- Visualizza tutti i libri che hai in prestito");
        print("5- Rinnova i prestiti entro la scadenza");
        //print("6- Visualizza la disponibilita' al prestito, dei libri nell'archivio");
        print("6- Logout");
        String choiche = scanner.nextLine();
        return choiche;        
    }
